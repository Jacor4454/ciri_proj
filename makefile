...
test: test.o class_tensor.o class_layer.o class_perceptron.o class_recersive.o
	$(COMPILER) $(CPPFLAGS) -Wall -g -pthread -o b $(OBJDIR)test.o $(OBJDIR)class_tensor.o $(OBJDIR)class_layer.o $(OBJDIR)class_perceptron.o $(OBJDIR)class_recersive.o /usr/lib/libgtest.a
